...
This exercise builts on top of exercise 3. You can use your own
solution of the exercise, or use the `Ex4.spthy` model in the `/models` folder.
Here's a reminder of how the protocol looks like:

![Protocol 1](./figures/ex4_fig.png)
