...
### Installing Tamarin on your machine
 ...
 Please install and use the latest release version 1.12.0. of the Tamarin prover for this lab.
 Instructions to install and use Tamarin can be found in the [Installation section](https://tamarin-prover.com/install.html) of the Tamarin website.



#### Code editors that support Tamarin syntax

* If you want to use syntax highlighting, we suggest using [Visual Studio Code](https://code.visualstudio.com) with [the official extension](https://marketplace.visualstudio.com/items?itemName=tamarin-prover.tamarin-prover) (search for extension with ID tamarin-prover.tamarin-prover).
...
* If you manually install Maude, make sure that you install Maude 2.7.1 or newer. Installing Maude with your package manager might result in an earlier version.
